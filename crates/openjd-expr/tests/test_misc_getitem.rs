...
// === getitem_list ===
#[test] fn list_index_first() { assert_eq!(eval("[10, 20, 30][0]").to_display_string(), "10"); }
#[test] fn list_index_last() { assert_eq!(eval("[10, 20, 30][2]").to_display_string(), "30"); }
#[test] fn list_index_neg() { assert_eq!(eval("[10, 20, 30][-1]").to_display_string(), "30"); }
#[test] fn list_index_neg2() { assert_eq!(eval("[10, 20, 30][-2]").to_display_string(), "20"); }
#[test] fn list_index_oob() {
    assert_err("[10, 20, 30][5]", &[
        "Index 5 out of bounds for list of length 3\n",
        "  [10, 20, 30][5]\n",
    ]);
}
#[test] fn list_index_neg_oob() {
    assert_err("[10, 20][-5]", &[
...
// === getitem_string ===
#[test] fn string_index_first() { assert_eq!(eval("'hello'[0]").to_display_string(), "h"); }
#[test] fn string_index_last() { assert_eq!(eval("'hello'[4]").to_display_string(), "o"); }
#[test] fn string_index_neg() { assert_eq!(eval("'hello'[-1]").to_display_string(), "o"); }
#[test] fn string_index_neg2() { assert_eq!(eval("'hello'[-2]").to_display_string(), "l"); }
#[test] fn string_index_oob() {
    assert_err("'hello'[10]", &[
