...
[issues that have the "help wanted" or "good first issue" labels](https://github.com/OpenJobDescription/openjd-rs/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22%2C%22help+wanted%22)
are a good place to start, but please dive into any issue that interests you whether it has those labels or not.

### Talk with us first

We ask that you please [open a feature request issue](https://github.com/OpenJobDescription/openjd-rs/issues/new/choose)
(if one does not already exist) and talk with us before posting a pull request that contains a significant amount of work,
or one that proposes a change to a public interface. We want to make sure that your time and effort is respected by working
...
[open a feature request issue](https://github.com/OpenJobDescription/openjd-rs/issues/new/choose). We will do our best to help
...
4. Commit to your fork using clear commit messages. Note that all Open Job Description GitHub repositories require the use
