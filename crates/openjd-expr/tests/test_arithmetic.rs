...
use openjd_expr::{evaluate_expression, ExpressionError, SymbolTable, ExprValue};
...
#[test] fn int_add() { assert_eq!(eval("1 + 2").to_display_string(), "3"); }
#[test] fn int_sub() { assert_eq!(eval("10 - 3").to_display_string(), "7"); }
#[test] fn int_mul() { assert_eq!(eval("4 * 5").to_display_string(), "20"); }
#[test] fn int_floordiv() { assert_eq!(eval("10 // 3").to_display_string(), "3"); }
#[test] fn int_mod() { assert_eq!(eval("10 % 3").to_display_string(), "1"); }
#[test] fn int_neg() { assert_eq!(eval("-5").to_display_string(), "-5"); }
#[test] fn int_pos() { assert_eq!(eval("+5").to_display_string(), "5"); }
#[test] fn int_precedence() { assert_eq!(eval("1 + 2 * 3").to_display_string(), "7"); }
#[test] fn int_parens() { assert_eq!(eval("(1 + 2) * 3").to_display_string(), "9"); }

#[test] fn float_add() { assert_eq!(eval("1.5 + 2.5").to_display_string(), "4.0"); }
#[test] fn float_sub() { assert_eq!(eval("5.0 - 1.5").to_display_string(), "3.5"); }
#[test] fn float_mul() { assert_eq!(eval("2.0 * 3.0").to_display_string(), "6.0"); }
#[test] fn float_div() { assert_eq!(eval("7.0 / 2.0").to_display_string(), "3.5"); }
...
fn float_passthrough_preserves_original() {
    ...
    st.set("Param.V", ExprValue::Float(Float64::with_str(3.5, "3.500".to_string()).unwrap())).unwrap();
...
#[test] fn int_division_returns_float() { assert_eq!(eval("10 / 4").to_display_string(), "2.5"); }
...
#[test] fn abs_negative() { assert_eq!(eval("abs(-5)").to_display_string(), "5"); }
#[test] fn abs_positive() { assert_eq!(eval("abs(5)").to_display_string(), "5"); }
#[test] fn min_two() { assert_eq!(eval("min(3, 7)").to_display_string(), "3"); }
#[test] fn max_two() { assert_eq!(eval("max(3, 7)").to_display_string(), "7"); }
#[test] fn floor_float() { assert_eq!(eval("floor(3.7)").to_display_string(), "3"); }
#[test] fn ceil_float() { assert_eq!(eval("ceil(3.2)").to_display_string(), "4"); }
#[test] fn round_half() { assert_eq!(eval("round(3.5)").to_display_string(), "4"); }

// === TestRoundToEven ===

#[test] fn round_half_to_even_0_5() { assert_eq!(eval("round(0.5)").to_display_string(), "0"); }
#[test] fn round_half_to_even_1_5() { assert_eq!(eval("round(1.5)").to_display_string(), "2"); }
#[test] fn round_half_to_even_2_5() { assert_eq!(eval("round(2.5)").to_display_string(), "2"); }
#[test] fn round_half_to_even_3_5() { assert_eq!(eval("round(3.5)").to_display_string(), "4"); }
#[test] fn round_half_to_even_4_5() { assert_eq!(eval("round(4.5)").to_display_string(), "4"); }
#[test] fn round_half_to_even_neg_0_5() { assert_eq!(eval("round(-0.5)").to_display_string(), "0"); }
#[test] fn round_half_to_even_neg_1_5() { assert_eq!(eval("round(-1.5)").to_display_string(), "-2"); }
#[test] fn round_half_to_even_neg_2_5() { assert_eq!(eval("round(-2.5)").to_display_string(), "-2"); }

#[test] fn round_ndigits_0_125() { assert_eq!(eval("round(0.125, 2)").to_display_string(), "0.12"); }
#[test] fn round_ndigits_0_375() { assert_eq!(eval("round(0.375, 2)").to_display_string(), "0.38"); }
#[test] fn round_ndigits_0_25() { assert_eq!(eval("round(0.25, 1)").to_display_string(), "0.2"); }
#[test] fn round_ndigits_0_75() { assert_eq!(eval("round(0.75, 1)").to_display_string(), "0.8"); }
#[test] fn round_ndigits_2_5_0() { assert_eq!(eval("round(2.5, 0)").to_display_string(), "2.0"); }
#[test] fn round_ndigits_3_5_0() { assert_eq!(eval("round(3.5, 0)").to_display_string(), "4.0"); }

#[test] fn round_int_ndigits_42_0() { assert_eq!(eval("round(42, 0)").to_display_string(), "42"); }
#[test] fn round_int_ndigits_42_2() { assert_eq!(eval("round(42, 2)").to_display_string(), "42"); }
#[test] fn round_int_ndigits_neg7_1() { assert_eq!(eval("round(-7, 1)").to_display_string(), "-7"); }
#[test] fn round_int_ndigits_11_neg1() { assert_eq!(eval("round(11, -1)").to_display_string(), "10"); }
#[test] fn round_int_ndigits_155_neg1() { assert_eq!(eval("round(155, -1)").to_display_string(), "160"); }
#[test] fn round_int_ndigits_155_neg2() { assert_eq!(eval("round(155, -2)").to_display_string(), "200"); }
#[test] fn round_int_ndigits_150_neg2() { assert_eq!(eval("round(150, -2)").to_display_string(), "200"); }
#[test] fn round_int_ndigits_250_neg2() { assert_eq!(eval("round(250, -2)").to_display_string(), "200"); }
...
#[test] fn sum_int_list() { assert_eq!(eval("sum([1, 2, 3])").to_display_string(), "6"); }
#[test] fn sum_float_list() { assert_eq!(eval("sum([1.5, 2.5])").to_display_string(), "4.0"); }
#[test]
fn sum_empty_list() {
    let r = eval("sum([])");
...
fn fail_raises_error() {
    assert_err("fail(\"custom error message\")", &[
...
fn fail_short_circuit_or_true() {
    assert_eq!(eval("true or fail(\"should not see\")").to_display_string(), "true");
}

#[test]
fn fail_short_circuit_or_false() {
    assert_err("false or fail(\"validation failed\")", &[
        "validation failed\n",
...
fn fail_short_circuit_and_false() {
    assert_eq!(eval("false and fail(\"should not see\")").to_display_string(), "false");
}

#[test]
fn fail_short_circuit_and_true() {
    assert_err("true and fail(\"validation failed\")", &[
        "validation failed\n",
...
fn fail_if_else_true_condition() {
    assert_eq!(eval("1.5 if true else fail(\"should not see\")").to_display_string(), "1.5");
}

#[test]
fn fail_if_else_false_condition() {
    assert_err("1 if false else fail(\"condition was false\")", &[
        "condition was false\n",
...
fn fail_validation_pattern() {
    assert_eq!(eval("5 > 0 or fail(\"must be positive\")").to_display_string(), "true");
    assert_err("-1 > 0 or fail(\"must be positive\")", &[
        "must be positive\n",
...
fn negative_zero_bit_normalized() {
    ...
    if let ExprValue::Float(f) = eval("-0.0") {
        assert!(f.value().is_sign_positive(), "expected +0.0 but got -0.0 (bit pattern not normalized)");
    } else {
        panic!("expected Float");
    }
    // Also check arithmetic that produces -0.0
    if let ExprValue::Float(f) = eval("-1.0 * 0.0") {
        assert!(f.value().is_sign_positive(), "expected +0.0 from -1.0 * 0.0");
    } else {
        panic!("expected Float");
    }
}
...
#[test] fn round_ndigits_0_625() { assert_eq!(eval("round(0.625, 2)").to_display_string(), "0.62"); }
#[test] fn round_ndigits_0_875() { assert_eq!(eval("round(0.875, 2)").to_display_string(), "0.88"); }
#[test] fn round_ndigits_neg_0_125() { assert_eq!(eval("round(-0.125, 2)").to_display_string(), "-0.12"); }
#[test] fn round_ndigits_neg_0_375() { assert_eq!(eval("round(-0.375, 2)").to_display_string(), "-0.38"); }
#[test] fn round_ndigits_neg_0_25() { assert_eq!(eval("round(-0.25, 1)").to_display_string(), "-0.2"); }
#[test] fn round_ndigits_neg_0_75() { assert_eq!(eval("round(-0.75, 1)").to_display_string(), "-0.8"); }
#[test] fn round_ndigits_neg_2_5_0() { assert_eq!(eval("round(-2.5, 0)").to_display_string(), "-2.0"); }
#[test] fn round_ndigits_neg_3_5_0() { assert_eq!(eval("round(-3.5, 0)").to_display_string(), "-4.0"); }

// TestFailFunction - missing cases

#[test]
fn fail_in_then_true_condition() {
    assert_err("fail(\"condition was true\") if true else 1", &[
        "condition was true\n",
...
fn fail_in_then_false_condition() {
    assert_eq!(eval("fail(\"should not see\") if false else 2.5").to_display_string(), "2.5");
}

#[test]
fn fail_if_else_various_types() {
    assert_eq!(eval("42 if true else fail(\"error\")").to_display_string(), "42");
    assert_eq!(eval("\"hello\" if true else fail(\"error\")").to_display_string(), "hello");
}

#[test]
fn fail_both_branches() {
    assert_err("fail(\"then\") if true else fail(\"else\")", &[
        "then\n",
...
fn mod_float_nextafter_just_below_divisor() {
    ...
    let val: f64 = match result { ExprValue::Float(f) => f.value(), _ => panic!("expected float") };
    assert!(val > 0.0 && val < 2.0, "expected positive result < 2.0, got {val}");
}
...
fn mod_float_nextafter_just_above_neg_divisor() {
    ...
    let result = eval(&expr);
    let val: f64 = match result { ExprValue::Float(f) => f.value(), _ => panic!("expected float") };
    assert!(val >= 0.0 && val < 2.0, "floored mod must be in [0, 2.0), got {val}");
}

#[test]
fn mod_float_result_sign_matches_divisor_positive() {
    // Floored modulo: result sign always matches divisor sign
    let val: f64 = match eval("-3.5 % 2.0") { ExprValue::Float(f) => f.value(), _ => panic!("expected float") };
    assert!(val >= 0.0, "floored mod with positive divisor must be >= 0, got {val}");
}

#[test]
fn mod_float_result_sign_matches_divisor_negative() {
    let val: f64 = match eval("3.5 % (-2.0)") { ExprValue::Float(f) => f.value(), _ => panic!("expected float") };
    assert!(val <= 0.0, "floored mod with negative divisor must be <= 0, got {val}");
}
